...
### User-supplied palette discipline

When an author provides candidate colours, do not simply apply them in the order listed. First decide the semantic roles
in the figure, then map colours to roles by salience and contrast.

Recommended workflow:

1. Identify the main claim category, reference category, deviation category, support categories, and residual/`Other` category.
2. Put medium-saturation, high-readability colours on the main claim and reference categories.
3. Put the darkest warm colour on thresholds, identity/reference lines, or signed deviations only when direction matters.
4. Put grey or the lightest pastel on `Other`, missing, background, or residual segments.
5. Check adjacent stacked-bar colours for lightness contrast; if two neighbours look similar, reorder them before changing the palette.
6. Preserve the same semantic mapping across every independent figure in a set.

Good mixed-category manuscript palettes include ColorBrewer-like soft sets such as
`#66C2A5`, `#FC8D62`, `#8DA0CB`, `#E78AC3`, `#A6D854`, `#FFD92F`, `#E5C494`, `#B3B3B3`.
For agreement/deviation figures, a cool/warm two-family palette such as `#87D0E8`, `#1B86F7`, `#F9B7B7`, `#F76B5A`,
and `#9D2929` can work when the darkest red is reserved for the identity or zero-difference line.
